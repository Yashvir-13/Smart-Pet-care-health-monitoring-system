...
const ProfilePage: React.FC = () => {
  ...
  const handleSaveProfile = () => {
    ...
    console.log('Saving profile:', petData);
    setIsEditing(false);
  };
          ...
          {isEditing ? (
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-lg font-medium">{currentPet.name}</p>
              </div>
              
              <div>
                <p className="text-sm text-gray-500">Pet Type</p>
                <p className="text-lg font-medium">{currentPet.type}</p>
              </div>
              
              <div>
                <p className="text-sm text-gray-500">Breed</p>
                <p className="text-lg font-medium">{currentPet.breed}</p>
              </div>
              
              <div>
                <p className="text-sm text-gray-500">Age</p>
                <p className="text-lg font-medium">{currentPet.age} years</p>
              </div>
              
              <div>
                <p className="text-sm text-gray-500">Weight</p>
                <p className="text-lg font-medium">{currentPet.weight} kg</p>
              </div>
              
              <div>
                <p className="text-sm text-gray-500">Sex</p>
                <p className="text-lg font-medium capitalize">{currentPet.sex}</p>
              </div>
            </div>
          )}
        </div>
